...
Start card implementation in a separate repository using the backend contracts finalized for Chores Manager `0.3.0`. The backend repository is functionally complete for the currently documented scope unless card work identifies a specific missing backend contract or defect.
...
4. Existing card analysis and household workflow notes outside this repository.
