...
| --- | --- | --- |
| [Inventory](INVENTORY_CONTRACT.md) | Children, chores, assignments, entity IDs, and week bounds | Authenticated user |
...
| [Current-week correction](CORRECTION_HISTORY_CONTRACT.md) | Read and set dated current-week completions | Authenticated user |
